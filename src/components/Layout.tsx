...
export default function Layout({ onLogout }: { onLogout: () => void }) {
  ...
  return (
    <div className="flex flex-col h-screen w-full bg-slate-100 text-slate-800 overflow-hidden font-sans">
      <header className="h-16 flex items-center justify-between px-6 bg-white border-b border-slate-200 shadow-sm shrink-0 z-30">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar */}
        <nav className="w-64 bg-slate-900 text-slate-300 flex flex-col shrink-0 relative z-20">
